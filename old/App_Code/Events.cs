...
public class Events
{
    ...
    public string getBannerImg() {
        ...
        return getDefaultBannerImage(imgData);

    }

    private string getDefaultBannerImage(List<images> imgData) {
        ...
        return "Default Image not Found";
    }

    private string getDefaultImage(List<images> imgData)
    {
    ...
    public string getImageData()
    {
        ...
        return getDefaultImage(imgData);
    }
}